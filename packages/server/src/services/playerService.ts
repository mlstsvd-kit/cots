...
export class PlayerService {
  ...
  static async updatePlayerStats(id: string, power?: number, harmony?: number, understanding?: number): Promise<PlayerProfile> {
    const updateData: any = {};
    if (power !== undefined) updateData.power = power;
    if (harmony !== undefined) updateData.harmony = harmony;
